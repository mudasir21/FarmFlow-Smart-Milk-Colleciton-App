...
class _HomeScreenDistributorState extends State<HomeScreenDistributor> {
  ...
  // Method to show date and slot selection dialog
  Future<Map<String, dynamic>?> _showDateAndSlotPicker(BuildContext context) async {
              ...
              return Column(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    value: selectedSlot,
                    items: ['Morning', 'Evening'].map((String slot) {
              ...
              onPressed: () {
                if (selectedDate != null && selectedSlot != null) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Please select both date and slot')),
                  );
                }
              },
          ...
          child: ListView(
            ...
            children: [
              ...
              _buildDrawerItem(
                ...
                onTap: () async {
                  Navigator.pop(context);
                  final result = await _showDateAndSlotPicker(context);
                  if (result != null) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
              ...
              _buildDrawerItem(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const DistributorStatisticsScreen1(),
                    ),
                  );
                },
              ),
  ...
  Widget _buildDrawerItem({
    ...
    return ListTile(
      leading: Icon(
        ...
        color: iconColor ?? (isActive ? Colors.green.shade700 : Colors.grey.shade700),
      ),
      title: Text(
        title,
        style: TextStyle(
          color: textColor ?? (isActive ? Colors.green.shade700 : Colors.black87),
